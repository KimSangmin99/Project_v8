		...
		try {
			URL url = new URL("https://kapi.kakao.com/v1/payment/ready");
				...
				if(gradeCheck==0) {
					...
					String parameter = "cid=TC0ONETIME&partner_order_id=partner_order_id&partner_user_id="+id+"&item_name="+grade+"&quantity=1&total_amount="+price+"&vat_amount=0&tax_free_amount=0&approval_url=http://localhost:9095/project10/homePage&fail_url=http://localhost:9095/project10/homePage&cancel_url=http://localhost:9095/project10/homePage";
